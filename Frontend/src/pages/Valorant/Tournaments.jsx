...
const ValorantTournaments = () => {
  const { data: valTournaments, loading, error } = useFetch(`${BASE_URL}/tournaments?game=valorant`);
  ...
  return (
    <div className="container page-anim" style={{ paddingTop: '8rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
        {valTournaments && valTournaments.length > 0 ? (
                  ...
                  {teamTournaments.map(t => (
                    ...
                    >
                      ...
                      <div style={{ position: 'absolute', top: '1rem', right: '1rem' }}>
                        <span style={{
                          background: t.status === 'Upcoming' ? 'rgba(34,211,238,0.15)' : `rgba(255,70,85,0.2)`,
