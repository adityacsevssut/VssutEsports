...
const ValorantTeamDetails = () => {
  const { teamId } = useParams();
  const team = valorantTeams.find(t => t.id === teamId);

  if (!team) {
    return (
      <div className="container page-anim" style={{ paddingTop: '8rem', textAlign: 'center' }}>
        <h1>Team Not Found</h1>
        <Link to="/valorant/organisers" className="btn btn-primary">Back to Organisers</Link>
      </div>
    );
  }
...
export default ValorantTeamDetails;
