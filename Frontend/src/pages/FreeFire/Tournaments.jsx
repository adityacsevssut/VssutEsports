...
const FreeFireTournaments = () => {
  ...
  return (
    <div className="container page-anim" style={{ paddingTop: '8rem' }}>
      <Link to="/freefire" style={{ marginBottom: '2rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: THEME, fontWeight: '600' }}>
                    ...
                    >
                      ...
                      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.75rem' }}>
                        ...
                        <Link
                          ...
                          style={{ '--card-accent': `linear-gradient(135deg, ${THEME}, #f97316)`, '--card-glow': GLOW }}
                        >
                          Explore
                        </Link>
                      </div>
